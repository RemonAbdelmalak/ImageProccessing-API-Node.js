...
import originalImg from './api/originalimg.routes'

const routes = express.Router();

routes.use('/api/originalimg', originalImg );
...
routes.get('/', (_req: express.Request, res: express.Response) => {
  res.send(
    `<h1>Hello, You Made it !!</h1>
        <p>To View the images go to /api/originalimg/?filename=
        ...
        <p>Examples:<ul><li><a href="http://localhost:3000/api/originalimg/?filename=1">http://localhost:3000/api/originalimg/?filename=1</a></li><li><a href="http://localhost:3000/api/images?filename=1&width=100&height=100">http://localhost:3000/api/images?filename=1&width=100&height=100</a></li></ul></p>
